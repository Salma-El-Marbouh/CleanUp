...
<html dir="ltr" lang="frensh">
  <head>
    ...
    <title>Eboueurs > Modification</title>
        <link
      rel="icon"
      type="images/png"
      sizes="16x16"
        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">Modification d'un éboueur </h4>
              ...
              <div class="card">
                ...
                <form class="form-horizontal">
                  <div class="card-body">
                    ...
                    <div class="form-group row">
                      <label class="col-md-3 mt-3">Prénom</label>
                      <div class="col-sm-9">
                        <input
                          type="text"
                          class="form-control"
                  ...
                  <div class="form-group row">
                      <label class="col-md-3 mt-3" >Téléphone</label>
                      <div class="col-sm-9">
                        <input
                          type="tel"
                          class="form-control"
