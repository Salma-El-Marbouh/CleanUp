        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">Déchets </h4>
            ...
            <div class="col-md-12">
              <div class="table-responsive mt-5" style="clear: both">
                      <table class="table table-hover">
                        ...
                        <tbody>
                          <tr>
                            <td class="text-center">Papier</td>
                          ...
                          <tr>
                            <td class="text-center">Plastique</td>
                            <td class="text-center"> 10kg </td>
                            <td class="text-center"> 25/01/2022 </td>
                          ...
                          <tr>
                            <td class="text-center">Organique</td>
                            <td class="text-center"> 10kg </td>
                            <td class="text-center"> 25/01/2022 </td>
                          ...
                          <tr>
                            <td class="text-center">Electronique</td>
                            <td class="text-center"> 10kg </td>
                            <td class="text-center"> 25/01/2022 </td>
