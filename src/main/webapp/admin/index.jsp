          ...
          >
            ...
            <ul class="navbar-nav float-end">
              ...
              <li class="nav-item dropdown">
                ...
                >
                  <a class="dropdown-item" href="profil_admin.jsp">
        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">Table de bord</h4>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-md-6 col-lg-2 col-xlg-3">
              ...
              <a href="index.jsp">
                <div class="box bg-cyan text-center">
                  ...
                  <h6 class="text-white">Table de bord</h6>
               </div>
               </a>
              </div>
            </div>
            ...
            <div class="col-md-6 col-lg-4 col-xlg-3">
              <div class="card card-hover">
              <a href="position/read.jsp">
                <div class="box bg-success text-center">
                  <h1 class="font-light text-white">
                    <i class="mdi mdi-map"></i>
                  </h1>
                  <h6 class="text-white">Points de reliefs</h6>
                </div>
                </a>
              </div>
            </div>
            ...
            <div class="col-md-6 col-lg-2 col-xlg-3">
              <div class="card card-hover">
              <a href="cleaner/read.jsp">
                <div class="box bg-warning text-center">
                  <h1 class="font-light text-white">
                    <i class="mdi mdi-account"></i>
                  </h1>
                  <h6 class="text-white">Eboueurs</h6>
                </div>
                </a>
              </div>
            </div>
            ...
            <div class="col-md-6 col-lg-2 col-xlg-3">
              <div class="card card-hover">
              <a href="trash/read.jsp">
                <div class="box bg-danger text-center">
                  <h1 class="font-light text-white">
                    <i class="mdi mdi-delete-empty"></i>
                  </h1>
                  <h6 class="text-white">Dechets</h6>
                </div>
                </a>
              </div>
            </div>
            ...
            <div class="col-md-6 col-lg-2 col-xlg-3">
              <div class="card card-hover">
              <a href="donation/read.jsp">
                <div class="box bg-info text-center">
                  <h1 class="font-light text-white">
                    <i class="mdi mdi-heart-box"></i>
                  </h1>
                  <h6 class="text-white">Dons</h6>
                </div>
                </a>
              </div>
            </div>
            ...
            <div class="col-md-6 col-lg-2 col-xlg-3">
              ...
              <a href="feedback.jsp">
                <div class="box bg-info text-center">
                  ...
                  <h6 class="text-white">Retroaction</h6>
                </div>
                </a>
              </div>
            </div>
