...
public class UpdatePositionController extends HttpServlet {
	...
	protected void doPost( HttpServletRequest request, HttpServletResponse response)
		    throws ServletException, IOException{
		        System.out.print(request.getParameter("position_id"));
		    	...
		    	Position position = new Position(Integer.parseInt(request.getParameter("position_id")), request.getParameter("ville"),request.getParameter("quartier"), request.getParameter("localisation") );
		    	
		    	boolean _position = positionService.updatePosition(position);
		    	if(_position == true) {
